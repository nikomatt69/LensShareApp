...
const Wrapper: FC<Props> = ({ children }) => {
  ...
  return (
   <> <div className="h-full mx-auto mb-10 md:mb-10 lg:mb-10 xs:mb-22 sm:mb-22 display:absolute max-w-[100rem]">
      {children}
      {selectedTrack && (
        <div className="sticky w-full z-[8] display:absolute rounded-xl border-x border-t border-blue-700 bg-blue-500 p-2 backdrop-blur-lg bg-gradient-to-b from-gray-900 to-transparent">
