...
const BottomNav: React.FC = () => {
  ...
  return (
    <div>
    <nav className="fixed bottom-0 left-0 right-0 h-[70px] border-b-0 border-t border-l border-r border-blue-700 rounded-lg border-2  bg-black  z-999 xl:w-[1200px] lg:w-[1100px] m-auto overflow-hidden items-center justify-around px-4 py-3">
     {/* //swap timelines */}
    { homePage ? (
      <Link href='/'>
        <button  
