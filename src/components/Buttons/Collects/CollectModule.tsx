...
import {
  ...
  LENSHUB_PROXY,
  RELAY_ON,
  UPDATE_OWNABLE_FEE_COLLECT_MODULE_ADDRESS
} from '@/constants';
      ...
      <>
        ...
        <div className="p-5">
          {collectModule?.followerOnly && (
            <div className="pb-5">Follower Only Collect Module</div>
          )}
          ...
          <div className="space-y-1.5">
              ...
              {collectModule?.collectLimit && (
                <div className="flex items-center space-x-2">
                  ...
                  <div className="font-bold">
                    {parseInt(collectModule?.collectLimit) - count} Avaliable
                  </div>
                </div>
              )}
            ...
            {data?.publication?.collectNftAddress && <div></div>}
          </div>
          ...
          <div className="mt-5 flex items-center space-x-2">
            {currentProfile && !hasCollectedByMe ? (
              allowanceLoading || balanceLoading ? (
                <div className="round-lg shimmer h-[34px] w-28" />
              ) : allowed ? (
                hasAmount ? (
                  <Button
