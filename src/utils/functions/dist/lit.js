...
var client = new sdk_browser_1['default'].LitNodeClient({
...
var Lit = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            return [
              4 /*yield*/,
              sdk_browser_1['default'].checkAndSignAuthMessage({ chain: chain })
            ];
          case 3:
            authSig = _b.sent();
          ...
          case 4:
            (_a = _b.sent()),
              (encryptedString = _a.encryptedString),
              (symmetricKey = _a.symmetricKey);
          ...
          case 6:
            ...
            return [
              2 /*return*/,
              {
                ...
                encryptedSymmetricKey: sdk_browser_1[
                  'default'
  ...
  Lit.prototype.decryptString = function (
    encryptedStr,
    encryptedSymmetricKey,
    address1,
    address2
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              sdk_browser_1['default'].decryptString(encryptedStr, symmetricKey)
            ];
          case 5:
