    ...
    >
      <span
        ...
        className={cn(
          ...
          'pointer-events-none inline-block h-[18px] w-[18px] transform rounded-full bg-white dark:bg-gray-900/70 shadow-lg ring-0 transition duration-200 ease-in-out'
        )}
      />
    </Switch>
  );
