    ...
    <label className="w-full" htmlFor={id}>
      {label && (
        <div className="mb-1 flex items-center space-x-1.5">
          ...
          <HelpTooltip children={helper} />
        </div>
      )}
      <div className="flex">
        {prefix && (
          <span className="lt-text-gray-500 inline-flex items-center rounded-l-xl border border-r-0 border-gray-300 bg-gray-100 px-3 dark:border-gray-700">
            {prefix}
          </span>
        )}
        <div
          className={cn(
            ...
            'focus-within:border-brand-500 focus-within:ring-brand-400 flex w-full items-center border border-gray-300 bg-white p-3 dark:border-gray-700 dark:bg-gray-100 dark:bg-gray-900/70'
          )}
        >
          <input
            id={id}
