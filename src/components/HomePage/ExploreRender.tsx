...
const ExploreRender = () => {
  ...
  return (
    <div>
    <div className="xl:w-[1200px] lg:w-[1100px] border-0 m-auto overflow-hidden h-[100vh]">
    <Toaster position="bottom-right" />
      
      <div className="flex gap-6 md:gap-20">
        <div className="h-[92vh] border-0 overflow-hidden hidden lg:block lg:hover:overflow-auto">
          <Sidebar />
        </div>
        <div className="mt-2 mb-8 pb-8 flex flex-col gap-10 overflow-auto border-0 overflow-x-hidden h-[88vh] videos flex-1">
          <Explore />
        </div>
      </div>
      <div className="block ">
