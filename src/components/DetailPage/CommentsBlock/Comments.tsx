...
const CommentsVideo: FC<Props> = ({ publication, profile }) => {
  ...
  return (
    <div className="overflow-y-auto">
      <div className=" h-flex gap-0.3 flex flex-grow flex-col items-stretch justify-center overflow-y-auto rounded-xl border-2 bg-gray-600/50 object-center pt-8 text-black ">
