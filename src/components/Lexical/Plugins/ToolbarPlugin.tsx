import Beta from '@/components/Composer/Actions/CollectSettings/Beta';
...
const ToolbarPlugin: FC = () => {
  ...
  return (
    <div className="divider flex items-center justify-between px-5 py-2 text-black dark:text-white">
